...
/**
 * @brief This class allows to link model syntax (CamelCase) and sql syntax (snake_case) using database information.
 *
...
{
    /**
     * @brief The array of fields name indexed by class and attribute name.
     * @var Array.
     */
    private $attrToField;
    /**
     * @brief The array of attributes name indexed by table and field name.
     * @var Array.
     */
    private $fieldToAttr;
    /**
     * @brief The array of attributes linked to primary keys.
     * @var Array.
     */
    private $primaryAttr;
    /**
     * @brief The array of attributes linked to auto incremented fields.
     * @var Array.
     */
    ...
    public function __construct(Mercure\Mercure $mercure, Services\IniParser $config)
    {
        ...
        {
            $attribute = lcfirst($this->createAttributeName($row->column_name, $row->table_name));
            
            $class = $this->createClassName($row->table_name);
    ...
    /**
     * @brief Get attributes which are linked with auto incremented fields.
    ...
    /**
     * @brief Get the class nale from the associated table name.
     * @param String $tableName The table name.
    ...
    /**
     * @brief Get attributes which are linked with primary keys.
     * @param String $className The class name.
     * @return Array The attributes name array.
     */
     ...
     * @param Mixed $object The object.
     * @return String The relative class name (without namespace).
     */
    ...
    /**
     * @brief Get the table name from the associated class.
     * @param String $className The class name.
	...
	/** 
     * @brief Create an attribute name from a field name and a table name.
     * @param String $fieldName The field name.
     * @param String $tableName The table name.
     * @return String The attribute name.
     */
    private function createAttributeName($fieldName, $tableName)
    {
	...
	/** 
     * @brief Create a class name from a table name.
     * @param String $tableName The table name.
     * @return String The classe name.
     */
    private function createClassName($tableName)
    {
